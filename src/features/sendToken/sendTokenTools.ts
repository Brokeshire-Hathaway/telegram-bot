...
export const tools: ChatCompletionTool[] = [
  {
    ...
    function: {
      ...
      description:
        "Prepare a transaction to send a token to a recipient and return a preview of what will happen",
      parameters: {
        type: "object",
        properties: {
          accountUid: {
          ...
          tokenAddress: {
            type: "string",
            description:
              "Optional address of the token to send. If not specified, the native network token will be sent.",
          },
        },
  ...
  },
  {
    ...
    function: {
      ...
      description:
        "Execute a transaction from a transaction UUID obtained from sendTokenPreview",
      parameters: {
        type: "object",
        properties: {
          transactionUuid: {
